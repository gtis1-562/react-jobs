...
/*  PART 1   */
//TODO: Create a fetch call that should be able to console.log the response data in JSON (You should see an object)     -- complete --
//TODO: How can you access the "jobs" from that object? (You should be able to access the array of job objects)     -- complete --
//TODO: Put that fetch call in a useEffect() *That will ONLY run when INTIALIZED.* (What does the dependancy module do?)    -- complete --
